...
enum EXComSpeakerType
{
    ...
    eSpeaker_Science,
    eSpeaker_Engineer,
    eSpeaker_FundingCouncil,
    eSpeaker_CommOfficer,
    eSpeaker_Soldier,
    eSpeaker_Volunteer,
    eSpeaker_SecurityGuardNPC,
    eSpeaker_ExtractionGenericVIP,
    eSpeaker_GenericSoldierNPC,
    eSpeaker_ExtractionMilitaryCommanderVIP,
    eSpeaker_ExtractionFemaleVIP,
    eSpeaker_Unknown,
    eSpeaker_SoldierFemale,
    eSpeaker_CommOfficerFemale,
    eSpeaker_Zhang,
    eSpeaker_Merc,
    eSpeaker_MAX
};
